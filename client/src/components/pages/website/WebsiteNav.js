...
function Nav(props) {
  ...
  <ul className="nav justify-content-center row">
    <li className="logo nav-item col-4 text-center">OUR WEDDING</li>
    ...
    <li className="guestlist nav-item col-2">
      <a className="nav-link js-scroll-trigger" href="#guestlist">guest list</a></li>
