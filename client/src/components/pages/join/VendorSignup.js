        ...
        <Container>
          <div className="container">
            ...
            >
              ...
              >
                <h1 className="pink-text title-font">
                  Hi, Welcome to QueerWed
                </h1>
                <br />
                <h5>
                ...
                <h5>
                  <a className="pink-text" href="#signUpQuestion">
                    <i className="fas fa-check mr-2" />You’re a sole proprietor
                    and identify as LGBTQIA+
                  </a>
                </h5>
                <h5>
                  <a className="pink-text" href="#signUpQuestion">
                    <i className="fas fa-check mr-2" />The owner or at least one
                    of your employees identify as LGBTQIA+
                  </a>
                </h5>
                <p>
                  <a className="grey-text" href="/">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Neither of
                    those, Take me back to the homepage
            ...
            >
              ...
              <div className="form-group">
                <label
                  ...
                  className="m-0 p-0 pink-text"
                >
                  What kind of business are you in?
                </label>
                <select
                  className="form-control mb-2 pl-0"
                  id="form1"
                  name="category"
                  size="1"
                  style={{
              ...
              <MDBContainer>
                <MDBRow>
                  ...
                  <MDBCol size="sm" className="pl-0 pr-0">
                    <Input
                      name="zipcode"
