...
const UserCard = (props) => (
    <div className="card z-depth-0 " style={{ border: "1px solid #eac7dc" }}>
        ...
        <div className="card-body user-card-body text-center p-5">
            ...
            <p className="card-text" style={{ fontSize: "17px" }}>Wedding Day : {props.dayOfWedding}</p>
            <p className="card-text" style={{ fontSize: "17px" }}>Number of Guests : {props.howManyGuest}</p>
            <p className="card-text" style={{ fontSize: "17px" }}>Favorite thing: {props.enjoyThing}</p>
            <p className="card-text" style={{ fontSize: "17px" }}><MDBIcon far icon="envelope mr-1" />{props.email}</p>
