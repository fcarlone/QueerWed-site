...
function Nav(props) {
  ...
  <ul className="nav justify-content-center row">
    <li className="logo nav-item col-5 text-left ml-2">OUR WEDDING</li>
    ...
    <li className="registry nav-item col-2 text-left">
      <a className="nav-link js-scroll-trigge" href="#registry">registry</a></li>
    ...
    <li className="rsvp nav-item col-2 text-left">
